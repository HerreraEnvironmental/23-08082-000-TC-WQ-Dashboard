      ...
      tabItems(
        ...
        tabItem(tabName ='sum_wqc',
                ...
                fluidRow(column(8,leafletOutput('wqc_map',height=800,width="100%")),
                         column(4,
                                ...
                                br(),
                                tags$em('Note: If map does not display to the left, there is insufficient data for selected year and parameter.'),
                                br(),
                                br(),
        ...
        tabItem(tabName ='trends',
                ...
                sidebarLayout(
                  sidebarPanel(width = 3,
                               ...
                               virtualSelectInput('trend_summary_parm','Select Parameter for Table and Plot',
                                           parm_list,multiple = F,search = T),
        ...
        tabItem(tabName ='wqi',
                ...
                fluidRow(column(12,sidebarLayout(
                  sidebarPanel(width=3,
                               virtualSelectInput('main_site','Select Site',sites_list, multiple = F,search=T),
        ...
        tabItem(tabName ='all_data',
                ...
                sidebarLayout(
                  sidebarPanel(width = 3,
                               virtualSelectInput('main_site2','Select Site',sites_list, multiple = F,search=T),
                               selectInput('data_year','Select Year to Highlight',years_list),
                               virtualSelectInput('trend_parm','Select Parameter',parm_list, multiple = F,search=T),
                               sliderInput('trend_years','Select Year Range for Trend',value=c(2000,2020),
                                           min=2000,max=2020,
                                           step=1,sep=''),
