...
ui <-
  dashboardPage(
    ...
    '
        ...
        tags$style(HTML(
          ".vscomp-dropbox {position: absolute; top: 0px !important;}"
        ))
      ),
      tags$script(HTML(
        '
      ...
      tabItems(
        tabItem(
          ...
          fluidRow(column(
            8,
            h5(
              "Below are all stations, active and inactive, used to monitor water quality in Thurston County. To learn more about a station, click on the icon and follow the prompts to various data tabs."
            )
          )),
